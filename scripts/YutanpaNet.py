...
if __name__ == '__main__':
    ...
    parser.add_argument( '-db', '--database', type = str, dest = 'tcdb', required=True, metavar = '<tcdb.faa>', help = 'MANDATORY. the file name or file name with the absolute address of the TCDB file in FASTA format.' )
    parser.add_argument( '-ra', '--rootaddress', type = str, dest = 'ra', required=True, metavar = '<address>', help = 'MANDATORY. the absolute address of the directory containing all plots generated by previous GBLAST multi-component system analysis. eg. "/ResearchData/Users/amedrano/RalfRabus/MultiomponentSystems/Desulfococcus_multivorans" ' )
    parser.add_argument( '-ft', '--featuretable', type = str, dest = 'ft', required=True, metavar = '<featuretable.txt.gz>', help = 'MANDATORY. the file name or file name with the absolute address of the genomic feature table in gzip compressed format.' )
    parser.add_argument( '-clan', '--clan_info_file', type = str, dest = 'clan', required=True, metavar = '<Pfam-A.clans.tsv.gz>', help = 'MANDATORY. the file name or file name with the absolute address of the Pfam clan table in gzip compressed format.' )
    parser.add_argument( '-l', '--linear', action = 'store_false', dest = 'linear', default = True, help = 'Flag. if set, the replicon structure of the genome in this analysis is circular. Otherwise, use the default setting: linear.' )
